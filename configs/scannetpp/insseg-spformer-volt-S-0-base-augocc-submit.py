...
weight = "/data2/program/3DInstSeg/Volt_Inst/weights/scannetpp-volt-B-base.pth"
...
model = dict(
    ...
    score_thr=0.0,
    npoint_thr=100,
    # mask_only_ignored_classes=True,
    nms=True,
)
...
data = dict(
    ...
    train=dict(
        ...
        transform=[
            ...
            dict(type="ScanNetppInstanceOccupancyAugmentor", shuffle_points=True,
                 scene_occupancy_path='/data2/program/3DInstSeg/Volt_Inst/data/scannetpp/instance_augment/scene_occupancy_surface_info_full_trainval.pkl',
                 floor_height_threshold=0.1,
                 ceiling_height_threshold=2.0,
                 db_sampler=dict(
                     db_info_path='/data2/program/3DInstSeg/Volt_Inst/data/scannetpp/instance_augment/instance_occupancy_info_trainval.pkl',
                     class_names=INST_LABELS_PP,
                     use_context=True,
                     use_class_balance=True,
                     placement_types_path='/data2/program/3DInstSeg/Volt_Inst/outputs/scannetpp_placement_types/scannetpp_placement_types.json',
                     class_names_num=dict(
                         all=1
                     ),
                 ),
            ),
