    ...
    train=dict(
        ...
        transform=[
            ...
            dict(type="ScanNetppInstanceOccupancyAugmentor", shuffle_points=True,
                 scene_occupancy_path='/data2/program/3DInstSeg/Volt_Inst/data/scannetpp/instance_augment/scene_occupancy_surface_info_full_train.pkl',
                 floor_height_threshold=0.1,
                 ceiling_height_threshold=2.0,
                 db_sampler=dict(
                     db_info_path='/data2/program/3DInstSeg/Volt_Inst/data/scannetpp/instance_augment/instance_occupancy_info.pkl',
