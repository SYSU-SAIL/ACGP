...
weight = "/data2/program/3DInstSeg/Volt_Inst/weights/pretrain_backbone/scannet-volt-B/model_best.pth"
...
data = dict(
    ...
    train=dict(
        ...
        data_root=data_root,
        transform=[
            dict(type="InstanceOccupancyAugmentor", shuffle_points=True,
                 scene_occupancy_path='data/scannet/instance_augment/scene_occupancy_surface_info_20_trainval.pkl',
                 db_sampler=dict(
                     db_info_path='data/scannet/instance_augment/instance_occupancy_info_20_trainval.pkl',
                     class_names=class_names,
                     use_context=True,
                     use_class_balance=False,
                     random_pose_prob=0.0,
                     placement_types_path='/data2/program/3DInstSeg/Volt_Inst/outputs/scannet_placement_types/scannet_placement_types.json',
