...
weight = "weights/volt-small-scannet.pth"
    ...
    train=dict(
        ...
        transform=[
            dict(type="InstanceOccupancyAugmentor", shuffle_points=True,
                 scene_occupancy_path='data/scannet/instance_augment/scene_occupancy_surface_info_20.pkl',
                 db_sampler=dict(
                     db_info_path='data/scannet/instance_augment/instance_occupancy_info_20.pkl',
