...
sync_data_pipeline = False
profile_train_runtime = False
strict_model_step_time = False
    ...
    train=dict(
        ...
        transform=[
            dict(type="InstanceOccupancyAugmentor", shuffle_points=True,
                 scene_occupancy_path='data/scannet/instance_augment/scene_occupancy_surface_info_200.pkl',
                 db_sampler=dict(
                     db_info_path='data/scannet/instance_augment/instance_occupancy_info_200.pkl',
                     class_names=class_names,
                     use_context=True,
                     use_class_balance=True,
                     placement_types_path='/data2/program/3DInstSeg/Volt_Inst/outputs/scannet200_placement_types/scannet200_placement_types.json',
