...
weight = "/data2/program/3DInstSeg/Volt_Inst/weights/scannet200-volt-B/new/model_best.pth"  # "/data2/program/3DInstSeg/Volt_Inst/weights/scannet200-volt-B/model_best.pth"
...
model = dict(
    ...
    decoder=dict(
        ...
        use_sgi_query_init=False,
        num_sample_query=200,
        num_learn_query=200,
        query_sample_ratio=0.4,
    ),
    criterion=dict(
        type="MRFormerCriterion",
        matcher=dict(
            type="MRFormerHungarianMatcher",
            costs=[
                dict(type="MRFormerQueryClassificationCost", weight=0.5),
                dict(type="MRFormerMaskBCECost", weight=1.0),
                dict(type="MRFormerMaskDiceCost", weight=1.0),
            ],
        ),
...
hooks = [
    ...
    dict(type="CheckpointSaver", save_freq=1, save_start_epoch=50),
